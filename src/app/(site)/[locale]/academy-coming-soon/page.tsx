...
import { GraduationCap, ArrowLeft, Send, Check, Dumbbell, Target, Users } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[rgb(var(--background))] flex items-center">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/3 right-1/3 w-[500px] h-[500px] bg-blue-500/5 rounded-full blur-[100px]" />
        <div className="absolute bottom-1/4 left-1/4 w-[350px] h-[350px] bg-[rgb(var(--accent)/0.04)] rounded-full blur-[80px]" />
