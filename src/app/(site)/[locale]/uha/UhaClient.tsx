            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-24 h-24 animate-spin-slow relative"
                  style={{ filter: "drop-shadow(0 0 10px rgba(153,27,27,0.5)) drop-shadow(0 0 20px rgba(153,27,27,0.2))" }}>
                  <Image src="/images/branding/logo-spinning.png" alt="UHA" fill className="object-contain" sizes="96px" />
                </div>
              </div>
            </motion.div>
          </div>
