...
export default function UhaPage() {
  ...
  const ecosystem = [
    { icon: ShoppingBag, label: "UHA Marketplace", desc: "Preorder krossovkalar va kiyimlar", href: "/marketplace", active: true },
    { icon: Shirt,        label: "UHA Merch",        desc: "Original UHA kiyim liniyasi",    href: "/merch",       active: true },
    { icon: Trophy,       label: "UHA League",       desc: "Basketbol turniri",              href: "/league-coming-soon", active: false },
    { icon: GraduationCap,label: "UHA Academy",      desc: "Trenirovka va rivojlanish",      href: "/academy-coming-soon", active: false },
  ];
  ...
  return (
    <div className="bg-[rgb(var(--background))] min-h-screen">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-[rgb(var(--surface))] border-b border-[rgb(var(--border))]">
      ...
      {/* Culture */}
      <section className="py-20 bg-[rgb(var(--surface))]">
        <div className="container-uha">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 className="font-display text-5xl tracking-wide text-[rgb(var(--foreground))] leading-none mb-6">
                {t("culture_title")}
              </h2>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="relative h-80 rounded-3xl overflow-hidden bg-[rgb(var(--surface-2))] border border-[rgb(var(--border))]"
            >
              <Image
                src="/images/products/shoes/jordan-1-lucky-green.jpeg"
                alt="Basketball culture"
                fill
                className="object-cover opacity-80"
                sizes="600px"
              />
              <div className="absolute inset-0 bg-gradient-to-br from-[rgb(var(--accent)/0.3)] to-transparent" />
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-24 h-24 rounded-full border-2 border-[rgb(var(--accent)/0.6)] flex items-center justify-center animate-spin-slow">
                  <span className="font-display text-2xl text-[rgb(var(--accent))]">UHA</span>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-[rgb(var(--surface))]">
        <div className="container-uha">
          <div className="mb-12">
            ...
            <h2 className="font-display text-5xl tracking-wide text-[rgb(var(--foreground))]">
              {t("ecosystem_title")}
            </h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {ecosystem.map(({ icon: Icon, label, desc, href, active }) => (
              <Link
                key={label}
                href={href}
                className="group p-5 bg-[rgb(var(--background))] border border-[rgb(var(--border))] rounded-2xl hover:border-[rgb(var(--accent)/0.4)] transition-all"
              >
