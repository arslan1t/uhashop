    ...
    <div className="min-h-screen bg-[rgb(var(--background))] flex items-center">
      ...
      <div className="container-uha relative z-10 py-20 max-w-2xl">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
          ...
          <Image src="/images/branding/league-logo.png" alt="UHA League" width={64} height={32} className="object-contain opacity-50" />
          <div>
            <p className="font-display text-base tracking-wider text-[rgb(var(--muted))]">UHA LEAGUE</p>
            <p className="text-xs text-[rgb(var(--muted)/0.5)] uppercase tracking-widest">Central Asia Basketball</p>
          </div>
        </motion.div>
      </div>
    </div>
